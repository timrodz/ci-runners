...
config :ci_runners, CiRunnersWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:ci_runners, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:ci_runners, ~w(--watch)]}
  ]
...
config :ci_runners, CiRunnersWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/ci_runners_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :ci_runners, dev_routes: true
